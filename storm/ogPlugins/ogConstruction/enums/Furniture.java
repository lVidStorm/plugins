package net.runelite.client.plugins.microbot.storm.ogPlugins.ogConstruction.enums;
...
public enum Furniture {
    ...
    MOUNTED_MYTHICAL_CAPE("Mythical Cape",15394,31986,4,ItemID.TEAK_PLANK,"Teak plank",3),
