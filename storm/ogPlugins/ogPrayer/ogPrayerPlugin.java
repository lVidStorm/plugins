...
public class ogPrayerPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.microbot.storm.ogPlugins.ogPrayer.ogPrayerOverlay ogPrayerOverlay;

    @Inject
    net.runelite.client.plugins.microbot.storm.ogPlugins.ogPrayer.ogPrayerScript ogPrayerScript;
