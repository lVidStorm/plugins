package net.runelite.client.plugins.microbot.storm.ogPlugins.ogConstruction;
...
import net.runelite.client.plugins.microbot.storm.ogPlugins.ogConstruction.enums.Furniture;
...
import net.runelite.client.plugins.microbot.storm.ogPlugins.ogConstruction.enums.Butler;
...
public class ogConstScript extends Script {
    ...
    private int coinsLeftInMoneyBag = 3000000;
    ...
    private boolean checkFurnitureBuilt(){
        System.out.println(Rs2GameObject.exists(furniture.getBuiltID()));
    ...
    private void fillMoneyBag(){
        ...
        if(Rs2Widget.findWidget("The moneybag ") != null){
            //TODO
            int i = 0; while(i<9) {
                System.out.println("money in moneybag : " + Rs2Widget.findWidget("The moneybag ").getText());
                i++;
            }
        }
        if(Rs2Widget.findWidget("The moneybag ") != null){
        ...
        //}
        sleepUntil(()-> Rs2Widget.findWidget("Select an Option") != null,Random.random(1600,1700));
        if(Rs2Widget.findWidget("Select an Option") != null){
            Rs2Keyboard.typeString("1");}
        sleepUntil(()-> Rs2Widget.findWidget("How many coins do you wish to deposit?") != null,Random.random(1600,1700));
        if(Rs2Widget.findWidget("How many coins do you wish to deposit?") != null){
            Rs2Keyboard.typeString(moneyBagTopUpAmount);}
        sleep(400,800);
        Rs2Keyboard.keyPress(KeyEvent.VK_ENTER);
        sleepUntil(()-> Rs2Widget.findWidget("The moneybag ") != null,Random.random(1600,1700));
    ...
    private int extractNumber(String text) {
        ...
        try {
            ...
            System.out.println("Failed to parse number from text: " + text);
        }
        return 0;
    }
    private int extractNumberOld(String input){
