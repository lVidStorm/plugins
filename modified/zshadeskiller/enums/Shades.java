...
public enum Shades {
    PHRIN("Phrin", Arrays.asList("Phrin Shade", "Phrin Shadow"), new WorldPoint(3493, 9723, 0),
            new WorldArea(3493, 9723, 6, 6, 0), net.runelite.client.plugins.microbot.storm.modified.zshadeskiller.enums.Area.Phrin_Shades, "Bronze"),
    RIYL("Riyl", Arrays.asList("Riyl Shade", "Riyl Shadow"), new WorldPoint(3493, 9707, 0),
            new WorldArea(3493, 9707, 6, 6, 0), net.runelite.client.plugins.microbot.storm.modified.zshadeskiller.enums.Area.Riyl_Shades, "Steel"),
    ...
    ASYN("Asyn", Arrays.asList("Asyn Shade", "Asyn Shadow"), new WorldPoint(3479, 9687, 0),
            new WorldArea(3479, 9687, 6, 6, 0), net.runelite.client.plugins.microbot.storm.modified.zshadeskiller.enums.Area.Asyn_Shades, "Black"),
    FIYR("Fiyr", Arrays.asList("Fiyr Shade", "Fiyr Shadow"), new WorldPoint(3466, 9708, 0),
            new WorldArea(3459, 9700, 8, 83, 0), net.runelite.client.plugins.microbot.storm.modified.zshadeskiller.enums.Area.Fiyr_Shades, "Silver"),
    URIUM("Urium", Arrays.asList("Urium Shade", "Urium Shadow"), new WorldPoint(3507, 9689, 0),
            new WorldArea(3507, 9677, 10, 14, 0), net.runelite.client.plugins.microbot.storm.modified.zshadeskiller.enums.Area.Urium_Shades, "Gold");
