...
import net.runelite.client.plugins.microbot.storm.modified.zwintertodt.zwintertodt.enums.Brazier;

@ConfigGroup("zwintertodt")
public interface zMWintertodtConfig extends Config {
    @ConfigSection(
            name = "General",
            description = "General",
            position = 0
    ...
    default String disclaimer() {
        return "Originally MOCROSOFT's Wintertodt plugin, modified\n" +
                "to \n" +
                "";
    }
    @ConfigSection(
