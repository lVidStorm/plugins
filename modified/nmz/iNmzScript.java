...
public class iNmzScript extends Script {

    public static double version = 2.0;

    public static iNmzConfig config;
    ...
    public boolean run(iNmzConfig config) {
        iNmzScript.config = config;
    ...
    public void useAbsorptionPotion() {
        if (Microbot.getVarbitValue(NMZ_ABSORPTION) < Random.random(config.minAbsorption(), config.maxAbsorption()) && Rs2Inventory.hasItem("absorption") && config.useAbsorption()) {
